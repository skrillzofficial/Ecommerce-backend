const parseVoiceQuery = (voiceText) => {
  ...
  const nigerianCities = [
    ...
    'benin', 'kaduna', 'jos', 'ilorin', 'enugu', 'abeokuta',
    'owerri', 'calabar', 'warri', 'onitsha', 'aba'
  ];
  ...
  // Extract category
  const categories = {
    tech: ['tech', 'technology', 'coding', 'programming', 'software', 'ai', 'blockchain'],
    music: ['music', 'concert', 'band', 'singing', 'dj', 'party'],
    sports: ['sports', 'football', 'basketball', 'fitness', 'gym', 'running'],
    business: ['business', 'conference', 'networking', 'startup', 'entrepreneur'],
    education: ['education', 'workshop', 'training', 'course', 'seminar', 'learning'],
  ...
  } else if (lowerText.includes('this weekend') || lowerText.includes('weekend')) {
  ...
  const removeWords = [
    'cheap', 'affordable', 'free', 'expensive', 'premium',
    'in', 'at', 'near', 'around', 'this', 'next', 'today',
    'tomorrow', 'week', 'weekend', 'month', 'events', 'event',
    'show', 'find', 'search', 'looking for', 'i want'
  ];
